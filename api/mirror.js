...
var fix=function(){
document.querySelectorAll('button,a,span,div,p').forEach(function(el){if(el.childElementCount>1)return;var s=(el.textContent||'').trim();if(/^skip(\s*intro)?\s*$/i.test(s)&&s.length<16){try{el.click();}catch(e){}var ov=el.closest('[class*="intro" i],[class*="splash" i],[class*="overlay" i],[class*="loader" i]');if(ov){try{ov.style.display='none';}catch(e){}}}});
